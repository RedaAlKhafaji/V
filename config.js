...
const CONFIG = {
    ...
    questions: {
        ...
        third: {
            ...
            yesBtn: "نعممم",                                             // Text for "Yes" button
            noBtn: "لاع"                                                 // Text for "No" button
        }
    },
    ...
    loveMessages: {
        extreme: "معقولهه تحبيني هلكدد 💝",  // Shows when they go past 5000%
        high: "لا هواي هيج 💝",              // Shows when they go past 1000%
        normal: "اكثر من ١٠٠؟ 🥰"                           // Shows when they go past 100%
    },
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/dju6udrnq/video/upload/v1769869463/half_ovmh74.mp3", // Music streaming URL
